...
AnimatedText8x8::AnimatedText8x8(Display *display, pixel_t boxWidth, uint16_t animationDelayMs, uint8_t tid) :
		display(display), tid(tid), boxWidth(boxWidth), data(alloc2DArray8(FONT8_HEIGHT, xDataSize)), xDataSize(
